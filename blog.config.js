...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'SingShun', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个基金经理，爱科技，爱投资，爱分享！', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://hxs.wiki', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '星舜的个人博客', // 网站关键词 英文逗号隔开
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'twikoo-hxs.up.railway.app', // TWIKOO地址 腾讯云环境填 envId；Vercel 环境域名地址（https://xxx.vercel.app)
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-L450HRPB7W', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
